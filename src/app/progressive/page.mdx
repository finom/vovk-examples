...
<Tabs items={['progressive-service.ts', 'progressive-controller.ts', 'progressive-example.tsx']}>
  <Tabs.Tab>
...
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/modules/progressive/progressive-controller.ts)*
  ...
  <Tabs.Tab>
```tsx showLineNumbers copy filename="src/app/progressive/progressive-example.tsx" repository="finom/vovk-examples"
'use client';
...
```
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/app/progressive/progressive-example.tsx)*
  </Tabs.Tab>
</Tabs>
