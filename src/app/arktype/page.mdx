...
<Tabs items={['UserArktypeController.ts', 'withArk.ts', 'ArktypeFormExample.tsx']}>
  <Tabs.Tab>
...
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/modules/arktype/UserArktypeController.ts)*
     ...
     <Tabs.Tab>
```ts showLineNumbers copy filename="src/lib/withArk.ts" repository="finom/vovk-examples"
// TODO
```
  </Tabs.Tab>
  <Tabs.Tab>
...
```
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/app/arktype/ArktypeFormExample.tsx)*
