...
<Tabs items={['basic-controller.ts', 'basic-example.tsx']}>
  <Tabs.Tab>
...
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/modules/basic/basic-controller.ts)*
  ...
  <Tabs.Tab>
```tsx showLineNumbers copy filename="src/app/basic/basic-example.tsx" repository="finom/vovk-examples"
'use client';
...
```
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/app/basic/basic-example.tsx)*
