...
<Tabs items={['PollController.ts', 'PollExample.tsx']}>
  <Tabs.Tab>
```ts showLineNumbers copy filename="src/modules/poll/PollController.ts" repository="finom/vovk-examples"
...
```
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/modules/poll/PollController.ts)*
  </Tabs.Tab>
  <Tabs.Tab>
```tsx showLineNumbers copy filename="src/app/poll/PollExample.tsx" repository="finom/vovk-examples"
404: Not Found
```
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/app/poll/PollExample.tsx)*
  </Tabs.Tab>
</Tabs>
