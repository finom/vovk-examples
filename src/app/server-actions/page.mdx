...
import ServerActionFormExample from './server-action-form-example';
...
<Tabs items={['actions.ts', 'server-action-form-example.tsx', 'form-zod-controller.ts']}>
  <Tabs.Tab>
...
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/app/server-actions/actions.ts)*
  ...
  <Tabs.Tab>
```tsx showLineNumbers copy filename="src/app/server-actions/server-action-form-example.tsx" repository="finom/vovk-examples"
'use client';
...
```
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/app/server-actions/server-action-form-example.tsx)*

  </Tabs.Tab>
  <Tabs.Tab>
```ts showLineNumbers copy filename="src/modules/form/form-zod-controller.ts" repository="finom/vovk-examples"
import { z } from 'zod';
...
```
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-examples/blob/main/src/modules/form/form-zod-controller.ts)*
