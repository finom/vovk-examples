// Generated by vovk-cli v0.0.1-draft.387 at 2025-11-01T15:14:11.722Z
...
>(schema, '', 'UserZodRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const UserZodWithServiceRPC = createRPC<
  Controllers0['UserZodWithServiceRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'UserZodWithServiceRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const UserYupRPC = createRPC<
  Controllers0['UserYupRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'UserYupRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const UserDtoRPC = createRPC<
  Controllers0['UserDtoRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'UserDtoRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const UserArktypeRPC = createRPC<
  Controllers0['UserArktypeRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'UserArktypeRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const UserValibotRPC = createRPC<
  Controllers0['UserValibotRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'UserValibotRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const BasicRPC = createRPC<
  Controllers0['BasicRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'BasicRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const BasicRPCWithService = createRPC<
  Controllers0['BasicRPCWithService'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'BasicRPCWithService', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const JSONLinesRPC = createRPC<
  Controllers0['JSONLinesRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'JSONLinesRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const JSONLinesResponseRPC = createRPC<
  Controllers0['JSONLinesResponseRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'JSONLinesResponseRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const OpenAiRPC = createRPC<
  Controllers0['OpenAiRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'OpenAiRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const AiSdkRPC = createRPC<
  Controllers0['AiSdkRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'AiSdkRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const ProxyRPC = createRPC<
  Controllers0['ProxyRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'ProxyRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const PollRPC = createRPC<
  Controllers0['PollRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'PollRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const ProgressiveRPC = createRPC<
  Controllers0['ProgressiveRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'ProgressiveRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const FormZodRPC = createRPC<
  Controllers0['FormZodRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, '', 'FormZodRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const OpenApiRPC = createRPC<
  Controllers1['OpenApiRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, 'static', 'OpenApiRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });

export const StaticParamsRPC = createRPC<
  Controllers1['StaticParamsRPC'],
  typeof import('vovk').fetcher extends VovkFetcher<infer U> ? U : never
>(schema, 'static', 'StaticParamsRPC', import('vovk'), { validateOnClient: import('vovk-ajv'), apiRoot: '/api' });
