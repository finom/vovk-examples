(() => {
  ...
  var lt;
  function ie(n, e) {
    return (lt || (lt = document.createElement('a')), (lt.href = e), n === lt.href);
  }
  function vn(n) {
    return Object.keys(n).length === 0;
  }
  var Hn = typeof window < 'u' ? window : typeof globalThis < 'u' ? globalThis : global,
    de = class {
      constructor(e) {
        ((this.options = e), (this._listeners = 'WeakMap' in Hn ? new WeakMap() : void 0));
      }
      observe(e, t) {
        return (
      ...
      _getObserver() {
        ...
        return (e = this._observer) !== null && e !== void 0
          ...
          : (this._observer = new ResizeObserver((t) => {
              var r;
              for (let s of t)
                (de.entries.set(s.target, s), (r = this._listeners.get(s.target)) === null || r === void 0 || r(s));
            }));
      }
    };
  ...
  var ot = class {
    ...
    m(e, t, r = null) {
      (this.e ||
        (this.is_svg ? (this.e = Pr(t.nodeName)) : (this.e = C(t.nodeType === 11 ? 'TEMPLATE' : t.nodeName)),
  ...
  function Wr(n) {
    let e = [],
      t = [];
    (se.forEach((r) => (n.indexOf(r) === -1 ? e.push(r) : t.push(r))), t.forEach((r) => r()), (se = e));
  }
  var it = new Set(),
    ee;
  function ae() {
  ...
  function Gr(n, e) {
    (n.$$.dirty[0] === -1 && (re.push(n), Br(), n.$$.dirty.fill(0)), (n.$$.dirty[(e / 31) | 0] |= 1 << e % 31));
  }
    ...
    if (
      ((f.ctx = t
        ? t(n, e.props || {}, (d, p, ...h) => {
            ...
            return (
              f.ctx && s(f.ctx[d], (f.ctx[d] = u)) && (!f.skip_bound && f.bound[d] && f.bound[d](u), c && Gr(n, d)),
              p
            );
          })
        : []),
      ...
      (e.intro && D(n.$$.fragment), me(n, e.target, e.anchor, e.customElement), Ir(), zn());
    }
    fe(o);
  }
  var Jr;
  typeof HTMLElement == 'function' &&
    (Jr = class extends HTMLElement {
      ...
      $set(n) {
        this.$$set && !vn(n) && ((this.$$.skip_bound = !0), this.$$set(n), (this.$$.skip_bound = !1));
      }
    });
  var q = class {
    $destroy() {
    ...
    if (l > 1 && l < 9) {
      ...
      for (
        s.charCodeAt(l) === 45 &&
          ...
          s.charCodeAt(l) === 45 &&
            (I(s.charCodeAt(l + 1)) && I(s.charCodeAt(l + 2)) && !I(s.charCodeAt(l + 3))
        ...
        if (o - a > 4 || (o - a > 3 && $(s.charCodeAt(a)))) (t.variants.push(r.slice(a, o)), (l = o));
        else break;
      }
      for (
        ;
        ...
        let a = l + 2,
          o = 0;
        for (; s.charCodeAt(a) === 45 && Z(s.charCodeAt(a + 1)) && Z(s.charCodeAt(a + 2)); ) {
          let f = a + 1;
          for (a = f + 2, o++; Z(s.charCodeAt(a)); ) {
            if (a - f > 7) return i(a, 2, 'Too long extension, expected at most 8 characters');
            a++;
          }
        }
        if (!o) return i(a, 4, 'Empty extension, extensions must have at least 2 characters of content');
        (t.extensions.push({ singleton: r.charAt(l + 1), extensions: r.slice(l + 3, a).split('-') }), (l = a));
      }
    } else l = 0;
    if ((l === 0 && s.charCodeAt(l) === 120) || (s.charCodeAt(l) === 45 && s.charCodeAt(l + 1) === 120)) {
      l = l ? l + 2 : 1;
      let a = l;
  ...
  function Zr(n) {
    ...
    return {
      ...
      p(a, o) {
        a[0] ? i || ((i = Ln(a)), i.c(), i.m(e.parentNode, e)) : i && (i.d(1), (i = null));
      },
      d(a) {
        (i && i.d(a), a && k(e), a && k(t));
      },
  ...
  function Xr(n) {
    ...
    return {
      ...
      p(u, _) {
        (u[0] ? (p ? p.p(u, _) : ((p = qn(u)), p.c(), p.m(e.parentNode, e))) : p && (p.d(1), (p = null)),
          _ & 2 && l !== (l = u[1].meta?.title + '') && z(i, l),
          _ & 2 && a !== (a = u[1].meta?.url || u[1].url) && m(s, 'href', a),
          _ & 2 && c !== (c = u[1].excerpt + '') && (f.innerHTML = c),
          u[2].length ? (h ? h.p(u, _) : ((h = Vn(u)), h.c(), h.m(t, null))) : h && (h.d(1), (h = null)));
      },
      d(u) {
  ...
  function Ln(n) {
    ...
    return {
      c() {
        ((e = C('div')), m(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-j9e30'));
      },
      m(t, r) {
        S(t, e, r);
      },
  ...
  function qn(n) {
    ...
    return {
      c() {
        ((e = C('div')), t && t.c(), m(e, 'class', 'pagefind-ui__result-thumb svelte-j9e30'));
      },
      m(r, s) {
        (S(r, e, s), t && t.m(e, null));
      },
      p(r, s) {
        r[1].meta.image ? (t ? t.p(r, s) : ((t = Bn(r)), t.c(), t.m(e, null))) : t && (t.d(1), (t = null));
      },
      d(r) {
        (r && k(e), t && t.d());
      },
    ...
    return {
      ...
      p(s, l) {
        (l & 2 && !ie(e.src, (t = s[1].meta?.image)) && m(e, 'src', t),
          l & 2 && r !== (r = s[1].meta?.image_alt || s[1].meta?.title) && m(e, 'alt', r));
      },
      d(s) {
        s && k(e);
      },
  ...
  function Qr(n) {
    ...
    return {
      ...
      p(l, [i]) {
        r === (r = t(l, i)) && s ? s.p(l, i) : (s.d(1), (s = r(l)), s && (s.c(), s.m(e, null)));
      },
      i: U,
      o: U,
      d(l) {
  ...
  var Mt = class extends q {
      constructor(e) {
        (super(), Y(this, e, xr, Qr, G, { show_images: 0, process_result: 4, result: 5 }));
      }
    },
    Gn = Mt;
  function Jn(n, e, t) {
  ...
  function $r(n) {
    ...
    return {
      ...
      p(a, o) {
        a[0] ? i || ((i = Zn(a)), i.c(), i.m(e.parentNode, e)) : i && (i.d(1), (i = null));
      },
      d(a) {
        (i && i.d(a), a && k(e), a && k(t));
      },
  ...
  function es(n) {
    ...
    return {
      ...
      m(E, b) {
        (d && d.m(E, b), S(E, e, b), S(E, t, b), R(t, r), R(r, s), R(s, i), R(t, o), p && p.m(t, null), R(t, f));
        for (let T = 0; T < u.length; T += 1) u[T] && u[T].m(t, null);
        (R(t, c), _ && _.m(t, null));
      },
      p(E, b) {
        if (
          (E[0] ? (d ? d.p(E, b) : ((d = Xn(E)), d.c(), d.m(e.parentNode, e))) : d && (d.d(1), (d = null)),
          b & 2 && l !== (l = E[1].meta?.title + '') && z(i, l),
          b & 2 && a !== (a = E[1].meta?.url || E[1].url) && m(s, 'href', a),
          E[4] ? (p ? p.p(E, b) : ((p = xn(E)), p.c(), p.m(t, f))) : p && (p.d(1), (p = null)),
          b & 8)
        ) {
          h = E[3];
          let T;
        ...
        E[2].length ? (_ ? _.p(E, b) : ((_ = er(E)), _.c(), _.m(t, null))) : _ && (_.d(1), (_ = null));
      },
      d(E) {
  ...
  function Zn(n) {
    ...
    return {
      c() {
        ((e = C('div')), m(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-4xnkmf'));
      },
      m(t, r) {
        S(t, e, r);
      },
  ...
  function Xn(n) {
    ...
    return {
      c() {
        ((e = C('div')), t && t.c(), m(e, 'class', 'pagefind-ui__result-thumb svelte-4xnkmf'));
      },
      m(r, s) {
        (S(r, e, s), t && t.m(e, null));
      },
      p(r, s) {
        r[1].meta.image ? (t ? t.p(r, s) : ((t = Qn(r)), t.c(), t.m(e, null))) : t && (t.d(1), (t = null));
      },
      d(r) {
        (r && k(e), t && t.d());
      },
  ...
  function xn(n) {
    ...
    return {
      c() {
        ((e = C('p')), m(e, 'class', 'pagefind-ui__result-excerpt svelte-4xnkmf'));
      },
      m(r, s) {
  ...
  function $n(n) {
    ...
    return {
      ...
      m(c, d) {
        (S(c, e, d), R(e, t), R(t, r), R(r, l), R(e, a), R(e, o), (o.innerHTML = f));
      },
      p(c, d) {
  ...
  function ts(n) {
    ...
    return {
      c() {
        ((e = C('li')), s.c(), m(e, 'class', 'pagefind-ui__result svelte-4xnkmf'));
      },
      m(l, i) {
        (S(l, e, i), s.m(e, null));
      },
      ...
      p = async (u) => {
        (t(1, (a = await u.data())),
          ...
          Array.isArray(a.sub_results) &&
            ...
            c ? t(3, (f = d(a.sub_results.slice(1), 3))) : t(3, (f = d([...a.sub_results], 3)))));
      },
  ...
  var At = class extends q {
      constructor(e) {
        (super(), Y(this, e, ns, ts, G, { show_images: 0, process_result: 6, result: 7 }));
      }
    },
    rr = At;
  function sr(n, e, t) {
  ...
  function ir(n) {
    ...
    return {
      ...
      p(o, f) {
        if ((f & 112 && r !== (r = o[4]('filters_label', o[5], o[6]) + '') && z(s, r), f & 143)) {
    ...
    return {
      ...
      p(M, y) {
        ((n = M),
          ...
          y & 2 && l !== (l = n[14]) && ((t.__value = l), (t.value = t.__value)),
          y & 3 && (t.checked = n[0][`${n[10]}:${n[14]}`]),
          y & 2 && f !== (f = n[14] + '') && o.p(f),
          y & 2 && d !== (d = n[15] + '') && z(p, d),
          y & 2 && u !== (u = n[10] + '-' + n[14]) && m(a, 'for', u),
          y & 3 && B(e, 'pagefind-ui__filter-value--checked', n[0][`${n[10]}:${n[14]}`]));
      },
      d(M) {
        (M && k(e), (E = !1), b());
      },
  ...
  function ur(n) {
    ...
    return {
      c() {
        ((e = C('details')), (t = C('summary')), (s = v()), (l = C('fieldset')), (i = C('legend')), (o = v()));
      ...
      m(h, u) {
        (S(h, e, u), R(e, t), (t.innerHTML = r), R(e, s), R(e, l), R(l, i), (i.innerHTML = a), R(l, o));
        for (let _ = 0; _ < p.length; _ += 1) p[_] && p[_].m(l, null);
        R(e, f);
      },
      p(h, u) {
        if (
          (u & 2 && r !== (r = h[10].replace(/^(\w)/, cr) + '') && (t.innerHTML = r),
        ...
        u & 138 && c !== (c = h[7] || h[3].map(_r).includes(h[10].toLowerCase())) && (e.open = c);
      },
      d(h) {
        (h && k(e), Q(p, h));
      },
    ...
    return {
      ...
      p(s, [l]) {
        (l & 2 && (e = s[1] && Object.entries(s[1]).length),
          e ? (r ? r.p(s, l) : ((r = ir(s)), r.c(), r.m(t.parentNode, t))) : r && (r.d(1), (r = null)));
      },
      i: U,
      o: U,
      d(s) {
      ...
      (n.$$.update = () => {
        if (n.$$.dirty & 258) {
          e: if (r && !c) {
            ...
            h.length === 1 && Object.entries(h[0][1])?.length <= 6 && t(7, (d = !0));
          }
        }
      }),
      [f, r, s, l, i, a, o, d, c, p]
  ...
  var yt = class extends q {
    ...
    fr = yt;
  var vt = {};
  A(vt, { comments: () => is, default: () => us, direction: () => as, strings: () => os, thanks_to: () => ls });
  ...
  var Ht = {};
  A(Ht, { comments: () => _s, default: () => hs, direction: () => fs, strings: () => ds, thanks_to: () => cs });
  var cs = 'Jermanuts',
    _s = '',
    fs = 'rtl',
    ds = {
  ...
  var wt = {};
  A(wt, { comments: () => ps, default: () => Rs, direction: () => gs, strings: () => Es, thanks_to: () => ms });
  ...
  var Ft = {};
  A(Ft, { comments: () => Ts, default: () => Ss, direction: () => Cs, strings: () => ks, thanks_to: () => bs });
  ...
  var Nt = {};
  A(Nt, { comments: () => As, default: () => Hs, direction: () => ys, strings: () => vs, thanks_to: () => Ms });
  ...
  var zt = {};
  A(zt, { comments: () => Fs, default: () => Os, direction: () => Ns, strings: () => zs, thanks_to: () => ws });
  ...
  var Ot = {};
  A(Ot, { comments: () => Us, default: () => Ps, direction: () => Ds, strings: () => Is, thanks_to: () => js });
  ...
  var jt = {};
  A(jt, { comments: () => qs, default: () => Ws, direction: () => Bs, strings: () => Vs, thanks_to: () => Ls });
  ...
  var Ut = {};
  A(Ut, { comments: () => Gs, default: () => Zs, direction: () => Js, strings: () => Ys, thanks_to: () => Ks });
  ...
  var Dt = {};
  A(Dt, { comments: () => Qs, default: () => el, direction: () => xs, strings: () => $s, thanks_to: () => Xs });
  ...
  var It = {};
  A(It, { comments: () => nl, default: () => ll, direction: () => rl, strings: () => sl, thanks_to: () => tl });
  ...
  var Pt = {};
  A(Pt, { comments: () => al, default: () => cl, direction: () => ol, strings: () => ul, thanks_to: () => il });
  ...
  var Lt = {};
  A(Lt, { comments: () => fl, default: () => ml, direction: () => dl, strings: () => hl, thanks_to: () => _l });
  ...
  var qt = {};
  A(qt, { comments: () => gl, default: () => bl, direction: () => El, strings: () => Rl, thanks_to: () => pl });
  ...
  var Bt = {};
  A(Bt, { comments: () => Cl, default: () => Ml, direction: () => kl, strings: () => Sl, thanks_to: () => Tl });
  ...
  var Vt = {};
  A(Vt, { comments: () => yl, default: () => wl, direction: () => vl, strings: () => Hl, thanks_to: () => Al });
  ...
  var Wt = {};
  A(Wt, { comments: () => Nl, default: () => jl, direction: () => zl, strings: () => Ol, thanks_to: () => Fl });
  ...
  var Kt = {};
  A(Kt, { comments: () => Dl, default: () => Ll, direction: () => Il, strings: () => Pl, thanks_to: () => Ul });
  ...
  var Gt = {};
  A(Gt, { comments: () => Bl, default: () => Kl, direction: () => Vl, strings: () => Wl, thanks_to: () => ql });
  var ql = 'Nixentric',
    Bl = '',
    Vl = 'ltr',
    Wl = {
  ...
  var Jt = {};
  A(Jt, { comments: () => Jl, default: () => Xl, direction: () => Yl, strings: () => Zl, thanks_to: () => Gl });
  ...
  var Yt = {};
  A(Yt, { comments: () => xl, default: () => ti, direction: () => $l, strings: () => ei, thanks_to: () => Ql });
  var Ql = 'Tate',
    xl = '',
    $l = 'ltr',
    ei = {
  ...
  var Zt = {};
  A(Zt, { comments: () => ri, default: () => ii, direction: () => si, strings: () => li, thanks_to: () => ni });
  ...
  var Xt = {};
  A(Xt, { comments: () => oi, default: () => _i, direction: () => ui, strings: () => ci, thanks_to: () => ai });
  var ai = '',
    oi = '',
    ui = 'ltr',
    ci = {
  ...
  var Qt = {};
  A(Qt, { comments: () => di, default: () => pi, direction: () => hi, strings: () => mi, thanks_to: () => fi });
  ...
  var xt = {};
  A(xt, { comments: () => Ei, default: () => Ti, direction: () => Ri, strings: () => bi, thanks_to: () => gi });
  ...
  var $t = {};
  A($t, { comments: () => ki, default: () => Ai, direction: () => Si, strings: () => Mi, thanks_to: () => Ci });
  ...
  var en = {};
  A(en, { comments: () => vi, default: () => Fi, direction: () => Hi, strings: () => wi, thanks_to: () => yi });
  ...
  var tn = {};
  A(tn, { comments: () => zi, default: () => Ui, direction: () => Oi, strings: () => ji, thanks_to: () => Ni });
  ...
  var nn = {};
  A(nn, { comments: () => Ii, default: () => qi, direction: () => Pi, strings: () => Li, thanks_to: () => Di });
  var Di = '',
    Ii = '',
    Pi = 'ltr',
    Li = {
  ...
  var rn = {};
  A(rn, { comments: () => Vi, default: () => Gi, direction: () => Wi, strings: () => Ki, thanks_to: () => Bi });
  var Bi = 'Jonatah',
    Vi = '',
    Wi = 'ltr',
    Ki = {
  ...
  var sn = {};
  A(sn, { comments: () => Yi, default: () => Qi, direction: () => Zi, strings: () => Xi, thanks_to: () => Ji });
  ...
  var ln = {};
  A(ln, { comments: () => $i, default: () => na, direction: () => ea, strings: () => ta, thanks_to: () => xi });
  ...
  var an = {};
  A(an, { comments: () => sa, default: () => aa, direction: () => la, strings: () => ia, thanks_to: () => ra });
  ...
  var on = {};
  A(on, { comments: () => ua, default: () => fa, direction: () => ca, strings: () => _a, thanks_to: () => oa });
  ...
  var un = {};
  A(un, { comments: () => ha, default: () => ga, direction: () => ma, strings: () => pa, thanks_to: () => da });
  var da = 'Anonymous',
    ha = '',
    ma = 'ltr',
    pa = {
  ...
  var cn = {};
  A(cn, { comments: () => Ra, default: () => Ca, direction: () => ba, strings: () => Ta, thanks_to: () => Ea });
  var Ea = '',
    Ra = '',
    ba = 'ltr',
    Ta = {
  ...
  var _n = {};
  A(_n, { comments: () => Sa, default: () => ya, direction: () => Ma, strings: () => Aa, thanks_to: () => ka });
  ...
  var fn = {};
  A(fn, { comments: () => Ha, default: () => Na, direction: () => wa, strings: () => Fa, thanks_to: () => va });
  ...
  var dn = {};
  A(dn, { comments: () => Oa, default: () => Da, direction: () => ja, strings: () => Ua, thanks_to: () => za });
  ...
  var hn = {};
  A(hn, { comments: () => Pa, default: () => Ba, direction: () => La, strings: () => qa, thanks_to: () => Ia });
  ...
  var mn = {};
  A(mn, { comments: () => Wa, default: () => Ja, direction: () => Ka, strings: () => Ga, thanks_to: () => Va });
  var Va = 'Amber Song',
    Wa = '',
    Ka = 'ltr',
    Ga = {
  ...
  var pn = {};
  A(pn, { comments: () => Za, default: () => xa, direction: () => Xa, strings: () => Qa, thanks_to: () => Ya });
  var Ya = 'Amber Song',
    Za = '',
    Xa = 'ltr',
    Qa = {
  ...
  var gn = {};
  A(gn, { comments: () => eo, default: () => ro, direction: () => to, strings: () => no, thanks_to: () => $a });
  var $a = 'Amber Song',
    eo = '',
    to = 'ltr',
    no = {
      ...
      le.push(() => Un(e, 'selected_filters', s)),
      {
        ...
        p(i, a) {
          ...
          (a[0] & 32 && (o.show_empty_filters = i[5]),
            ...
            !t && a[0] & 1 && ((t = !0), (o.selected_filters = i[0]), Nn(() => (t = !1))),
            e.$set(o));
        },
        i(i) {
  ...
  function gr(n) {
    ...
    return (
      ...
      {
        c() {
          ((e = C('div')), r.c(), m(e, 'class', 'pagefind-ui__results-area svelte-e9gkc3'));
        },
        m(o, f) {
  ...
  function io(n) {
    let e,
      ...
      o;
    function f(_, E) {
      return _[13].results.length === 0 ? co : _[13].results.length === 1 ? uo : oo;
    }
    let c = f(n, [-1, -1]),
      d = c(n),
    ...
    return {
      ...
      p(_, E) {
        (c === (c = f(_, E)) && d ? d.p(_, E) : (d.d(1), (d = c(_)), d && (d.c(), d.m(e, null))),
          E[0] & 139292 &&
            ((p = _[13].results.slice(0, _[17])), ae(), (s = jn(s, E, h, 1, _, p, l, r, On, Er, null, mr)), oe()),
  ...
  function ao(n) {
    ...
    return {
      ...
      p(r, s) {
        r[16] ? (t ? t.p(r, s) : ((t = br(r)), t.c(), t.m(e.parentNode, e))) : t && (t.d(1), (t = null));
      },
      i: U,
      o: U,
      d(r) {
          ...
          e !==
            (e =
              r[20]('many_results', r[19], r[7])
                ...
                .replace(/\[COUNT\]/, new Intl.NumberFormat(r[7].language).format(r[13].results.length)) + '') &&
          z(t, e);
      },
      d(r) {
        r && k(t);
          ...
          e !==
            (e =
              r[20]('one_result', r[19], r[7])
                .replace(/\[SEARCH_TERM\]/, r[16])
                .replace(/\[COUNT\]/, new Intl.NumberFormat(r[7].language).format(1)) + '') &&
          z(t, e);
      },
      d(r) {
        r && k(t);
  ...
  function co(n) {
    ...
    return {
      ...
      p(r, s) {
        s[0] & 589952 &&
          e !== (e = r[20]('zero_results', r[19], r[7]).replace(/\[SEARCH_TERM\]/, r[16]) + '') &&
          z(t, e);
      },
      d(r) {
        r && k(t);
  ...
  function _o(n) {
    let e, t;
    return (
      (e = new Gn({ props: { show_images: n[2], process_result: n[4], result: n[51] } })),
      {
        c() {
          ut(e.$$.fragment);
        },
  ...
  function fo(n) {
    let e, t;
    return (
      (e = new rr({ props: { show_images: n[2], process_result: n[4], result: n[51] } })),
      {
        c() {
          ut(e.$$.fragment);
        },
  ...
  function Rr(n) {
    ...
    return {
      c() {
        ((e = C('button')), (r = w(t)), m(e, 'type', 'button'), m(e, 'class', 'pagefind-ui__button svelte-e9gkc3'));
      },
      m(i, a) {
        (S(i, e, a), R(e, r), s || ((l = J(e, 'click', n[22])), (s = !0)));
      },
      p(i, a) {
        a[0] & 524416 && t !== (t = i[20]('load_more', i[19], i[7]) + '') && z(r, t);
      },
      d(i) {
        (i && k(e), (s = !1), l());
      },
  ...
  function br(n) {
    ...
    return {
      c() {
        ((e = C('p')), (r = w(t)), m(e, 'class', 'pagefind-ui__message svelte-e9gkc3'));
      },
      m(s, l) {
        (S(s, e, l), R(e, r));
      },
      p(s, l) {
        l[0] & 589952 && t !== (t = s[20]('searching', s[19], s[7]).replace(/\[SEARCH_TERM\]/, s[16]) + '') && z(r, t);
      },
      d(s) {
        s && k(e);
      },
  ...
  function ho(n) {
    ...
    return {
      ...
      p(M, y) {
        ((!u || (y[0] & 524416 && s !== (s = M[20]('placeholder', M[19], M[7])))) && m(r, 'placeholder', s),
          (!u || (y[0] & 524416 && l !== (l = M[20]('placeholder', M[19], M[7])))) && m(r, 'title', l),
          (!u || y[0] & 256) && (r.autofocus = M[8]),
          y[0] & 512 && r.value !== M[9] && Tt(r, M[9]),
          (!u || y[0] & 524416) && o !== (o = M[20]('clear_search', M[19], M[7]) + '') && z(f, o),
          ...
          (!u || (y[0] & 524416 && h !== (h = M[20]('search_label', M[19], M[7])))) && m(t, 'aria-label', h),
      ...
      d(M) {
        (M && k(e), n[34](null), n[35](null), b && b.d(), T && T.d(), (_ = !1), K(E));
      },
    };
  }
  ...
  function po(n, e, t) {
    ...
    for (let g = 0; g < s.length; g++) r[s[g]] = { language: s[g], ...dr[g].strings };
    ...
    (Ct(() => {
      ...
      t(
        19,
        (Sn =
          r[`${N.language}-${N.script}-${N.region}`] || r[`${N.language}-${N.region}`] || r[`${N.language}`] || r.en)
      );
    }),
      kt(() => {
        (F?.destroy?.(), (F = null));
...
`)
          ...
          await g.options(N);
          for (let j of b) {
            if (!j.bundlePath) throw new Error('mergeIndex requires a bundlePath parameter');
            let L = j.bundlePath;
      ...
      Sr = async () => {
        F && ((kn = await F.filters()), (!ce || !Object.keys(ce).length) && t(18, (ce = kn)));
      },
      Mr = (g) => {
        let N = {};
        return (
      ...
      Ar = async (g, N) => {
        ...
        let j = Mr(N),
          L = () => yr(g, j);
        (_ > 0 && g ? (_e && clearTimeout(_e), (_e = setTimeout(L, _)), await An(), F.preload(g, { filters: j })) : L(),
          vr());
      },
      An = async () => {
      ...
      yr = async (g, N) => {
        (t(16, (Cn = g || '')), typeof p == 'function' && (g = p(g)), t(14, (dt = !0)), t(15, (ht = !0)), await An());
        let j = ++Tn,
          L = { filters: N };
      ...
      wr = (g) => {
        (g.key === 'Escape' && (t(9, (H = '')), O.blur()), g.key === 'Enter' && g.preventDefault());
      };
    function Fr() {
  ...
  try {
    document?.currentScript &&
      ...
      (Rn = new URL(document.currentScript.src).pathname.match(/^(.*\/)(?:pagefind-)?ui.js.*$/)[1]);
  } catch {
    Rn = '/pagefind/';
  }
  var _t = class {
